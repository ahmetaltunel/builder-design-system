...
private let componentSeeds: [ComponentSeed] = [
    .init(name: "Alert", category: .feedbackOverlay, previewGroup: .feedback),
    .init(name: "Anchor navigation", category: .shellNavigation, previewGroup: .navigation),
    .init(name: "Area chart", category: .specialized, previewGroup: .data),
    .init(name: "App layout", category: .shellNavigation, previewGroup: .shell),
    .init(name: "App layout toolbar", category: .shellNavigation, previewGroup: .toolbar),
    .init(name: "Attribute editor", category: .specialized, previewGroup: .specialized),
    .init(name: "Autosuggest", category: .inputSelection, previewGroup: .form),
    .init(name: "Avatar", category: .specialized, previewGroup: .ai),
    .init(name: "Badge", category: .feedbackOverlay, previewGroup: .feedback),
    .init(name: "Bar chart", category: .specialized, previewGroup: .data),
    .init(name: "Board", category: .collectionContent, previewGroup: .content),
    .init(name: "Board item", category: .collectionContent, previewGroup: .content),
    .init(name: "Box", category: .shellNavigation, previewGroup: .content),
    .init(name: "Breadcrumb group", category: .shellNavigation, previewGroup: .navigation),
    .init(name: "Button", category: .inputSelection, previewGroup: .selection),
    .init(name: "Button dropdown", category: .inputSelection, previewGroup: .selection),
    .init(name: "Button group", category: .inputSelection, previewGroup: .selection),
    .init(name: "Calendar", category: .specialized, previewGroup: .tutorial),
    .init(name: "Cards", category: .collectionContent, previewGroup: .content),
    .init(name: "Chat bubble", category: .specialized, previewGroup: .ai),
    .init(name: "Charts", category: .specialized, previewGroup: .data),
    .init(name: "Checkbox", category: .inputSelection, previewGroup: .selection),
    .init(name: "Code editor", category: .collectionContent, previewGroup: .utility),
    .init(name: "Code view", category: .collectionContent, previewGroup: .utility),
    .init(name: "View preferences", category: .inputSelection, previewGroup: .form),
    .init(name: "Filter select", category: .inputSelection, previewGroup: .selection),
    .init(name: "Column layout", category: .shellNavigation, previewGroup: .content),
    .init(name: "Container", category: .shellNavigation, previewGroup: .content),
    .init(name: "Content layout", category: .shellNavigation, previewGroup: .content),
    .init(name: "Copy to clipboard", category: .collectionContent, previewGroup: .utility),
    .init(name: "Date input", category: .inputSelection, previewGroup: .form),
    .init(name: "Date picker", category: .inputSelection, previewGroup: .form),
    .init(name: "Date range picker", category: .inputSelection, previewGroup: .form),
    .init(name: "Donut chart", category: .specialized, previewGroup: .data),
    .init(name: "Drawer", category: .feedbackOverlay, previewGroup: .overlay),
    .init(name: "Empty state", category: .feedbackOverlay, previewGroup: .feedback),
    .init(name: "Error boundary", category: .feedbackOverlay, previewGroup: .feedback),
    .init(name: "Expandable section", category: .collectionContent, previewGroup: .content),
    .init(name: "File picker button", category: .specialized, previewGroup: .specialized),
    .init(name: "File token group", category: .specialized, previewGroup: .specialized),
    .init(name: "File upload field", category: .specialized, previewGroup: .specialized),
    .init(name: "File uploading components", category: .specialized, previewGroup: .specialized),
    .init(name: "Notice stack", category: .feedbackOverlay, previewGroup: .feedback),
    .init(name: "Form", category: .inputSelection, previewGroup: .form),
    .init(name: "Form field", category: .inputSelection, previewGroup: .form),
    .init(name: "Generative AI components", category: .specialized, previewGroup: .ai),
    .init(name: "Grid", category: .shellNavigation, previewGroup: .content),
    .init(name: "Header", category: .shellNavigation, previewGroup: .toolbar),
    .init(name: "Help panel", category: .specialized, previewGroup: .specialized),
    .init(name: "Context panel", category: .specialized, previewGroup: .specialized),
    .init(name: "Icon", category: .collectionContent, previewGroup: .utility),
    .init(name: "Input", category: .inputSelection, previewGroup: .form),
    .init(name: "Items palette", category: .collectionContent, previewGroup: .content),
    .init(name: "Key-value pairs", category: .collectionContent, previewGroup: .content),
    .init(name: "Line chart", category: .specialized, previewGroup: .data),
    .init(name: "Link", category: .collectionContent, previewGroup: .utility),
    .init(name: "List", category: .collectionContent, previewGroup: .content),
    .init(name: "Live region", category: .feedbackOverlay, previewGroup: .feedback),
    .init(name: "Loading bar", category: .feedbackOverlay, previewGroup: .feedback),
    .init(name: "Modal", category: .feedbackOverlay, previewGroup: .overlay),
    .init(name: "Mixed chart", category: .specialized, previewGroup: .data),
    .init(name: "Multiselect", category: .inputSelection, previewGroup: .selection),
    .init(name: "Pagination", category: .collectionContent, previewGroup: .content),
    .init(name: "Panel layout", category: .shellNavigation, previewGroup: .shell),
    .init(name: "Popover", category: .feedbackOverlay, previewGroup: .overlay),
    .init(name: "Progress bar", category: .feedbackOverlay, previewGroup: .feedback),
    .init(name: "Prompt input", category: .specialized, previewGroup: .ai),
    .init(name: "Property filter", category: .inputSelection, previewGroup: .selection),
    .init(name: "Radio group", category: .inputSelection, previewGroup: .selection),
    .init(name: "Resource selector", category: .specialized, previewGroup: .specialized),
    .init(name: "Segmented control", category: .inputSelection, previewGroup: .selection),
    .init(name: "Select", category: .inputSelection, previewGroup: .selection),
    .init(name: "Side navigation", category: .shellNavigation, previewGroup: .navigation),
    .init(name: "Slider", category: .inputSelection, previewGroup: .selection),
    .init(name: "Space between", category: .shellNavigation, previewGroup: .content),
    .init(name: "Spinner", category: .feedbackOverlay, previewGroup: .feedback),
    .init(name: "Split panel", category: .shellNavigation, previewGroup: .shell),
    .init(name: "Status indicator", category: .feedbackOverlay, previewGroup: .feedback),
    .init(name: "Steps", category: .specialized, previewGroup: .tutorial),
    .init(name: "Support prompt group", category: .specialized, previewGroup: .ai),
    .init(name: "Table", category: .collectionContent, previewGroup: .data),
    .init(name: "Tabs", category: .collectionContent, previewGroup: .content),
    .init(name: "Tag editor", category: .inputSelection, previewGroup: .selection),
    .init(name: "Text content", category: .collectionContent, previewGroup: .content),
    .init(name: "Text filter", category: .inputSelection, previewGroup: .form),
    .init(name: "Text area", category: .inputSelection, previewGroup: .form),
    .init(name: "Tiles", category: .inputSelection, previewGroup: .selection),
    .init(name: "Time input", category: .inputSelection, previewGroup: .form),
    .init(name: "Toggle", category: .inputSelection, previewGroup: .selection),
    .init(name: "Toggle button", category: .inputSelection, previewGroup: .selection),
    .init(name: "Token", category: .inputSelection, previewGroup: .selection),
    .init(name: "Token group", category: .inputSelection, previewGroup: .selection),
    .init(name: "Top navigation", category: .shellNavigation, previewGroup: .navigation),
    .init(name: "Tree view", category: .collectionContent, previewGroup: .content),
    .init(name: "Tutorial components", category: .specialized, previewGroup: .tutorial),
    .init(name: "Tutorial panel", category: .specialized, previewGroup: .tutorial),
    .init(name: "Wizard", category: .specialized, previewGroup: .tutorial)
]
